...
This project provides an example Node.js with Express.js project for SIC43NT rolling code authentication on web application. SIC43NT tag provider can apply this concept to allow SIC43NT tag holders to verify their tags as well as communicate to them regarding the tag status.
...
SIC43NT Tag provides 4 distinct NDEF contents coded in Hexadecimal string which can be passed to web service directly. The contents includes
...
4. vim to change port 3000 to 8080 in app.js file and save:
```
vim app.js
```
```
...
5. Create app.yaml for App engine flexible.
```
vim app.yaml
```
...
7. view the app in your cloud shell toolbar, click "Web preview" and select "Preview on port 8080.".
